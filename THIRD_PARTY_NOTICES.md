...
This project includes source code from the following third-party components:
...
PipeWire, and systemd/libsystemd. These libraries are not redistributed in this
repository and remain under their respective upstream and distribution licenses.
